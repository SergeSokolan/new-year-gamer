export const contestData = [
    ...
    },
    {
        ...
        prizes: [{
            ...
            winners: ['Nikitime','Rew1l','Vishenka_Cherry','affatograf','almazova6009','bZdiggeR','lacrinore','muxaspb89','Odeyalko200x220','PahomChik0','Staleks','ARDRU_','ASAGIUS','AVATARru','DezRoze','DSLow','eg0rch1k','EMOBLAZE','feelthetrance_','GrimReaperBunny','Kwei1','odinokii_sosochek','savokat','sniks610','sushion','Verdani0','YogurtWithSpoon','Rom_STARK','Journey93','bogsoul','Devywka_Valerianka','DokerStim','helmars','Jade_kenig','marabern','markillioo','MrBASS94','1President','agnitumus','D1mosaur','eger_iskogen','gatarelub','goggi_din','Grin01','itByte','kirruta','KJIuMywKa','leksike','Makc2312','Mysticmk','ObJluK','shpikls','warnetik','Abyss_Wat4ers','crazy_slesar','Delacroix','dubolom228','enotik2231','Eppo_','gunibUll','hells012','HidaN_Immortal','LeoAlexsonStream','m1g8','Nodgluk','Vasya_v_Adidase','waid_manns','kakmnogobykv','kekcpekc','Nialir','Ovikulia','sirindoom','xxx2pro','HitBazooka','Linreid']
        }]
    },
    {
        contestName: "Конкурс #9",
        prizes: [{
            prizeName: "Razer Клавиатура + Мышь",
            winners: ['nake3333','kit_deck3r','Meltin_','PR0GRAMM1ST','LeBomjareaux','caxp_caxp','varf','alichant','affatograf','obmorok7','SasoriAF','sniks610','soulFAQ','frayz3017','EMOBLAZE']
        }]
    },
    {
